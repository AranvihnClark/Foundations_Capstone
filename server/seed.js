    ...
    seed: (req, res) => {
        sequelize.query(`
            ...
            CREATE TABLE travelers(
                ...
                interrogate_features TEXT NOT NULL, 
                inspect_clothing TEXT NOT NULL,
                inspect_wares TEXT NOT NULL,
                inspect_special TEXT
                );

            INSERT INTO travelers(name, age, occupation, good, height, weight, difficulty, interrogate_traveler, interrogate_features, inspect_clothing, inspect_wares, inspect_special)
            VALUES ('Esther Goodwill', 74, 'Retired Shopkeeper', true, '4'' 9''''', '95 lb', 'Easy',
                    ...
                    ('Johnathan Hershel', 22, 'Libraian''s Aide', true, '6'' 1''''', '172 lb', 'Easy',
                    ...
                    ('Jessebell Angler', 16, 'Student', true, '4'' 8''''', '81 lb', 'Easy',
                    ...
                    ('Duncan Turner', 28, 'Soldier', true, '6'' 2''''', '194 lb', 'Medium',
                    ...
                    ('Geoffrey Goldmine', 57, 'Merchant', true, '4'' 6''''', '271 lb', 'Medium',
                    ...
                    ('Veronica Highland', 43, 'Secretary of State', true, '5'' 8''''', '155 lb', 'Medium',
                    ...
                    ('Tina Goodfellow', 31, 'Circus Troupe Leader', true, '4'' 11''''', '106 lb', 'Hard',
                    ...
                    ('Mary Wellington', 19, 'Daughter of a Viscount', true, '5'' 7''''', '110 lb', 'Hard', 
                    ...
                    ('Chris Rain', 32, 'Mugger', false, '6'' 0''''', '202 lb', 'Easy',
                    ...
                    'The leather satchel has a small knife wrapped in a brown cloth inside of it. In his backpack, it looks like he is carrying a couple of days worth of rations, a worn bedroll, a torch, and an old crude map. The knife seems to have been wiped recently.',
                    ...
                    ('Serena Burns', 29, 'Arsonist', false, '5'' 7''''', '102 lb', 'Medium', 
                    ...
                    ('Sophia Hope', 24, 'Serial Killer', false, '5'' 3''''', '91 lb', 'Hard', 
